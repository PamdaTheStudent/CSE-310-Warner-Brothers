...
final FloorData _floor3 = FloorData(
  ...
  navNodes: const {
    'N1': NavNode(
      id: 'N1',
      position: Offset(453, 184),
      neighbors: ['N5', 'N2'],
    ),
    'N2': NavNode(
      id: 'N2',
      position: Offset(560, 184),
      neighbors: ['N1', 'N3'],
    ),
    'N3': NavNode(
      id: 'N3',
      position: Offset(591, 185),
      neighbors: ['N2', 'N4'],
    ),
    'N4': NavNode(id: 'N4', position: Offset(694, 183), neighbors: ['N3']),
    'N5': NavNode(
      id: 'N5',
      position: Offset(433, 186),
      neighbors: ['N6', 'N1'],
    ),
    'N6': NavNode(
      id: 'N6',
      position: Offset(329, 183),
      neighbors: ['N7', 'N5'],
    ),
    'N7': NavNode(
      id: 'N7',
      position: Offset(306, 181),
      neighbors: ['N10', 'N8', 'N6'],
    ),
    'N8': NavNode(
      id: 'N8',
      position: Offset(305, 164),
      neighbors: ['N7', 'N9'],
    ),
    'N9': NavNode(id: 'N9', position: Offset(305, 139), neighbors: ['N8']),
    'N10': NavNode(
      id: 'N10',
      position: Offset(312, 294),
      neighbors: ['N11', 'N7'],
    ),
    'N11': NavNode(
      id: 'N11',
      position: Offset(321, 459),
      neighbors: ['N12', 'N10'],
    ),
    'N12': NavNode(
      id: 'N12',
      position: Offset(334, 513),
      neighbors: ['N13', 'N11'],
    ),
    'N13': NavNode(
      id: 'N13',
      position: Offset(286, 522),
      neighbors: ['N14', 'N12'],
    ),
